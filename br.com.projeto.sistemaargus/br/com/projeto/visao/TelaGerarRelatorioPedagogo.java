...
public class TelaGerarRelatorioPedagogo extends JInternalFrame {
	...
	private JButton btnGerarProfissional;
	
	public TelaGerarRelatorioPedagogo() {
    	setTitle("Gerar Relatorio PDF");
    	setClosable(true);
		...
		contentPane.setBounds(0, 0, 370, 150);
		...
		btnGerar.setBounds(63, 109, 90, 28);
		...
		btnGerarProfissional = new JButton("Gerar Rel. Prof.");
		btnGerarProfissional.setFont(new Font("SansSerif", Font.BOLD, 12));
		btnGerarProfissional.setBounds(190, 109, 114, 28);
		contentPane.add(btnGerarProfissional);
	...
	public JButton getBtnGerarProfissional() {
		return btnGerarProfissional;
	}
